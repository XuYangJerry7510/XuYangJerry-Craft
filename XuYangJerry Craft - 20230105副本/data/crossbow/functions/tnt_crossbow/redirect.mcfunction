...
execute at @a[scores={Menu_crossbow=3}] run function crossbow:tnt_crossbow/settings
...
execute at @a[scores={Menu_tntcrossbow=1..12}] run function crossbow:tnt_crossbow/settings
