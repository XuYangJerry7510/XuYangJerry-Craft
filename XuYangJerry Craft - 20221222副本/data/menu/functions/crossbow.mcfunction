...
# 爆炸弩
execute if score tnt_crossbow Projects matches 0 run tellraw @a ["",{"text": "---【爆炸弩】","hoverEvent": {"action": "show_text","value": "爆炸弩\n使弩射出的箭具有爆炸性\n一起boom~吧"}},{"text": "开启","color": "gray","clickEvent": {"action": "run_command","value": "/trigger Menu_crossbow set 1"}},{"text": "/","color": "gray"},{"text": "关闭","color": "red","bold": true}]
execute if score tnt_crossbow Projects matches 1 run tellraw @a ["",{"text": "---【爆炸弩】","hoverEvent": {"action": "show_text","value": "爆炸弩\n使弩射出的箭具有爆炸性\n一起boom~吧"}},{"text": "开启","color": "green","bold": true},{"text": "/","color": "gray"},{"text": "关闭","color": "gray","clickEvent": {"action": "run_command","value": "/trigger Menu_crossbow set 2"}}]
