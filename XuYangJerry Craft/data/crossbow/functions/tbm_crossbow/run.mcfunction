execute as @e[type=#minecraft:arrows,nbt={PierceLevel:30b}] run tag @p add Consumption_tnt
execute as @e[type=#minecraft:arrows,nbt={PierceLevel:30b}] run data merge entity @s {Tags:[arrow_explode],PierceLevel:0b}
execute if score tnt_crossbow_arrows_path_explosion Projects matches 1 at @e[type=#minecraft:arrows,tag=arrow_explode] run summon minecraft:tnt ~ ~3 ~ {Fuse:60}
...
execute if score tnt_crossbow_consumption_tnt Projects matches 1 if score @a[tag=Consumption_tnt,limit=1] Consume_tnt matches 1 at @e[type=#minecraft:arrows,tag=arrow_explode,nbt={inGround:1b}] run give @a[tag=Consumption_tnt,gamemode=creative] minecraft:tnt 1
...
execute if score tnt_crossbow_self_explosion Projects matches 1 at @e[type=#minecraft:arrows,tag=arrow_explode,nbt={inGround:1b}] at @a[tag=Consumption_tnt,] run summon tnt
